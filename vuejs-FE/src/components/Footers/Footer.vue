    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap text-center lg:text-left">
        <div class="w-full lg:w-6/12 px-4">
          <h4 class="text-3xl font-semibold">Giữ liên lạc với chúng tôi!</h4>
          <h5 class="text-lg mt-0 mb-2 text-blueGray-600">
            Tìm chúng tôi trên bất kỳ nền tảng nào dưới đây, chúng tôi sẽ phản hồi trong vòng 1–2
            ngày làm việc.
          </h5>
